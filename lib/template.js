...
// patriq => this is the base template for SQL files
...
// patriq => this function generates a file (sql or js or something else) based on cli input
Template.prototype.getTemplate = function () {
  switch (this.templateType) {
    // patriq => sql-file below. looks lik this is just a modifiable string...
