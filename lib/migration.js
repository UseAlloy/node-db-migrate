...
Migration.prototype.sqlUpTemplate = function () {
  return [
    ...
    '',
    '/* Please reference our [README.md](https://github.com/UseAlloy/Alloy/blob/master/UncleWaldo/README.md) file for recommended standards/practices. */'
  ].join('\n');
};
...
Migration.prototype.downSqlTemplate = function () {
  return [
    ...
    '',
    '/* If you are writing a down migration for local development, please reference our [README.md](https://github.com/UseAlloy/Alloy/blob/master/UncleWaldo/README.md) file for recommended standards/practices. */'
  ].join('\n');
};
