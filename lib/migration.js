...
Migration.prototype.upSqlTemplate = function () {
  return [
    '/*   NOTE: Please be VERY careful about removing these timeouts. They are there to',
    '     prevent table locking due to unexpectedly long running migrations and/or service',
    '     interruption. Depending on your migration, you might need to remove them. */',
    ...
    '',
    '',
    '/*   NOTE: Also, please dont remove these unless you have a good reason. Same thinking. */',
...
Migration.prototype.downSqlTemplate = function () {
  return [
    ...
    "SET statement_timeout TO '10s';",
    '',
    '/*   WARNING!! Alloy does not officially support down migrations. That said, you are welcome to write down',
    '     migrations for local development. For more information on the subject, please see our official',
